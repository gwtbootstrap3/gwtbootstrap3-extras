 ...
 * @author Pavel Zlámal
 */
public enum GrowlType implements org.gwtbootstrap3.client.ui.constants.Type, com.google.gwt.dom.client.Style.HasCssName {
    ...
    public static GrowlType fromStyleName(final String styleName) {
        return EnumHelper.fromStyleName(styleName, GrowlType.class, INFO);
    }
