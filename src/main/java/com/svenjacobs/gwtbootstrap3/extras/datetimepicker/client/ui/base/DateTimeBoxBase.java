package com.svenjacobs.gwtbootstrap3.extras.datetimepicker.client.ui.base;
...
import com.svenjacobs.gwtbootstrap3.extras.datetimepicker.client.ui.base.constants.*;
...
public class DateTimeBoxBase extends Widget implements HasValue<Date>, HasEnabled, HasValueChangeHandlers<Date>,
    ...
    protected native void configure(Element e, boolean showTime, boolean showDate, boolean useStrict,
        ...
        .on('change.dp', function () {
            that.@com.svenjacobs.gwtbootstrap3.extras.datetimepicker.client.ui.base.DateTimeBoxBase::onChange()();
        })
        .on("show.dp", function (e) {
            that.@com.svenjacobs.gwtbootstrap3.extras.datetimepicker.client.ui.base.DateTimeBoxBase::onShow(Lcom/google/gwt/user/client/Event;)(e);
        })
        .on("hide.dp", function (e) {
            that.@com.svenjacobs.gwtbootstrap3.extras.datetimepicker.client.ui.base.DateTimeBoxBase::onHide(Lcom/google/gwt/user/client/Event;)(e);
        });
    }-*/;
}
